...
--
-- Host: localhost:3306
-- Generation Time: Oct 19, 2018 at 06:27 PM
...
INSERT INTO `interview` (`interview_id`, `name`, `level`, `specialization`, `date`, `status`, `interviewee_id`) VALUES
(2, 'Don Aubrey', '1', 'Frontend developer', '06.09.2018', 'ok', 0),
(3, 'Sophia Carson', '2', 'Frontend developer', '11.09.2018', 'ok', 0),
(45, 'asdas', '2', 'Frontend developer', '01.10.2018', 'ok', 0),
(48, 'dssdfsdf', '2', 'Frontend developer', '02.10.2018', 'ok', 0);
...
INSERT INTO `interviewee` (`interviewee_id`, `name`, `qualification`, `specialization`, `skills`) VALUES
(3, 'Don Aubrey', '', '', '');
...
--
ALTER TABLE `question_card`
  MODIFY `question_card_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
--
...
ALTER TABLE `question_card`
  ...
  ADD CONSTRAINT `question_card_ibfk_4` FOREIGN KEY (`interview_id`) REFERENCES `interview` (`interview_id`);
