...
--
-- Host: localhost:3306
-- Generation Time: Nov 02, 2018 at 05:57 PM
...
(2, 'Don Aubrey', '1', 'Frontend developer', '06.09.2018', 'empty'),
(3, 'Sophia Carson', '2', 'Frontend developer', '11.09.2018', 'completed'),
(45, 'asdas', '2', 'Frontend developer', '01.10.2018', 'completed'),
(48, 'dssdfsdf', '2', 'Frontend developer', '02.10.2018', 'completed');
...
INSERT INTO `interviewee` (`interviewee_id`, `name`, `qualification`, `specialization`, `skills`, `email`) VALUES
(3, 'Don Aubrey', '', '', '', '');
...
(13, 7, '4', 'What is NaN? What is its type? How can you reliably test if a value is equal to NaN?What is NaN? What is its type? How can you reliably test if a value is equal to NaN?', 'Read more books'),
...
(13, 3, '91', '', 16, 'js'),
(14, 3, '62', '', 17, 'js'),
(16, 48, '18', 'asdasdasdas', 2, 'html'),
(18, 48, '44', 'sd', 6, 'html'),
(32, 48, '56', 'dasdasdasdadsasdasdasdas', 13, 'js'),
(33, 48, '31', '', 14, 'js'),
(67, 48, '22', '', 11, 'css'),
(68, 48, '72', '', 12, 'css'),
(70, 48, '0', '', 5, 'html'),
...
INSERT INTO `user` (`user_id`, `name`, `password`, `rights`, `token`, `email`) VALUES
(1, 'j.doe', '123456789', 'user', '123456789', 'likecoffee@yandex.ru'),
(2, 'm.smith', '12345678', 'admin', '121212', 'likecoffee@yandex.ru');
...
--
ALTER TABLE `interviewee`
  MODIFY `interviewee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `question_card`
  MODIFY `question_card_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
--
...
ALTER TABLE `question_card`
  ...
  ADD CONSTRAINT `question_card_ibfk_4` FOREIGN KEY (`interview_id`) REFERENCES `interview` (`interview_id`) ON DELETE CASCADE;
